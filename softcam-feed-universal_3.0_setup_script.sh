...
SUCCESS="""
***********************************************
The new feed source was successfully installed!
You can try to sync the list of available
installation packages in the set top box:
  opkg update
***********************************************
"""
...
try_append_feed_source "http://nonpublic.space/$IMAGEBASE/$DISTROVERSION/$ARCH"
